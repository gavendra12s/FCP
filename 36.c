// Write a program that define a generic data container capable of storing either an integer a float,a charcter,or a string
// The program should include function to set and get the data from the container ensuring type safety
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
