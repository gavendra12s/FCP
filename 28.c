//pointer arithmatic : write a program to illustrate the following basic pointer arithmatic operation
// a. increment a pointer B.decrement a pointer C. add an integer to a pointer D. subtract an integer from a pointer
//E. subtract two pointer of same type
#include <stdio.h>
