//let A[n] be an array of n distinct integers picked from the range [0,10000] write a c program that print the largest integer
// that can be made out of n integers Example : A={944,9,0,45} OUTPUT IS 9944450
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
