//Writes a c program that reads n names and corresponding n addresses, rearranges the name in alphabatical order 
// and then print the alphabatically sorted string make use of structure varaible within the program
#include <stdio.h>
#include <string.h>
